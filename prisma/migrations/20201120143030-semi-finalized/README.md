# Migration `20201120143030-semi-finalized`

This migration has been generated by prantaDutta at 11/20/2020, 8:30:30 PM.
...
```sql
BEGIN;
CREATE TYPE "Role_new" AS ENUM ('admin', 'borrower', 'lender');
